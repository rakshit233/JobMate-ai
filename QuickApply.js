        ...
        <div>
          ...
          <div style={{ background: C.white, borderRadius: 12, border: `0.5px solid ${C.gray200}`, padding: "18px 22px", marginBottom: 16 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                <button onClick={() => { if (onGoToResume) onGoToResume(result.tailoredCV, selectedProfile, result.cvStructured); }}
          ...
          <div style={{ background: C.navy, borderRadius: 12, padding: "20px 24px" }}>
            ...
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              ...
              <button onClick={() => {
                if (onGoToResume) onGoToResume(result.tailoredCV, selectedProfile, result.cvStructured);
              }}
